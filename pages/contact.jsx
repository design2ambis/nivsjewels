      ...
      <div id="main-content" className="main-content">
        <div id="primary" className="content-area">
          <div id="title" className="page-title">
            <div className="section-container" style={{ paddingTop: 60 }}>
              <div className="content-title-heading">
                <h1 className="text-title-heading" style={{ color: "#fff" }}>
                  Contact Us
                </h1>
              </div>
                ...
                <div className="section-container small">
                  ...
                  <div className="block block-contact-map">
                    <div className="block-widget-wrap">
                      <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d978.8798223927288!2d76.94333937517456!3d11.074622097560646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8f7abc1861e11%3A0xd3fa18a505114569!2sNivs%20jewels!5e0!3m2!1sen!2sin!4v1701847400019!5m2!1sen!2sin"
                        aria-label="Nivs"
                      />
                    </div>
                  </div>
                        ...
                        <div className="row">
                          <div className="col-md-4 sm-m-b-30">
                            <div className="info-item">
                              ...
                              <div className="item-content">+91 9150016196</div>
                            </div>
                          </div>
                          <div className="col-md-4 sm-m-b-30">
                            <div className="info-item">
