          ...
          <div id="content" className="site-content" role="main">
            <section className="section m-b-70">
              ...
              <div className="block block-sliders auto-height color-white nav-center">
                <div
                  className="slick-sliders bannerheight banner"
                  data-autoplay="true"
                  data-dots="true"
                  data-nav="true"
                  data-columns4={1}
                ...
                >
                  <div className="item slick-slide">
                    <div className="item-content">
                      <div className="content-image">
                        {/*<img width="1920" height="1080" src="assets/images/B1.jpg" alt="Image Slider">*/}
                        <img src="/assets/img/Nivs1.jpg" alt="Image Slider" />
                      </div>
                    </div>
                  </div>
                  <div className="item slick-slide">
                    <div className="item-content">
                      <div className="content-image">
                        {/*<img width="1920" height="1080" src="assets/images/B2.jpg" alt="Image Slider">*/}
                        <img src="/assets/img/Nivs2.jpg" alt="Image Slider" />
                      </div>
                    </div>
                  </div>
                  <div className="item slick-slide">
                    <div className="item-content">
                      <div className="content-image">
                        {/*<img width="1920" height="1080" src="assets/images/B3.jpg" alt="Image Slider">*/}
                        <img src="/assets/img/Nivs3.jpg" alt="Image Slider" />
                      </div>
                    </div>
                  </div>
                  <div className="item slick-slide">
                    <div className="item-content">
                      <div className="content-image">
                        {/*<img width="1920" height="1080" src="assets/images/B3.jpg" alt="Image Slider">*/}
                        <img src="/assets/img/Nivs4.jpg" alt="Image Slider" />
                      </div>
                    </div>
                  </div>
                  ...
                  {/*            <img width="1920" height="1080" src="assets/images/B4.jpg" alt="Image Slider">*/}
                  {/*        </div>*/}
                              ...
                              <div className="banner-image">
                                <a href="#!">
                                  <img
                                    width={630}
                                    height={457}
                                    src="assets/images/sb01.png"
                                    alt="Banner Image"
                                  />
                                  {/*media/banner/banner-1-1.jpg*/}
                                </a>
                              </div>
            ...
            <section className="section section-padding background-img bg-img-2 m-b-70 p-t-140 p-b-70 m-t-n-130">
              <div className="section-container">
                ...
                {/*                                    </div>*/}
                {/*                                </div>*/}
                {/*                                <h2 class="testimonial-title">“Amazing piece of history”*/}
                {/*                                </h2>*/}
                {/*                                <div class="testimonial-excerpt">*/}
                {/*                                    Blood bank canine teeth larynx occupational*/}
                {/*                                    therapist oncologist optician plaque spinal tap stat*/}
                {/*                                    strep...*/}
                {/*                                </div>*/}
                {/*                            </div>*/}
                ...
                {/*                                <div class="thumbnail">*/}
                {/*                                    <img width="110" height="110"*/}
                {/*                                        src="media/testimonial/4.jpg" alt="">*/}
                {/*                                </div>*/}
                {/*                                <div class="testimonial-info">*/}
                {/*                                    <h2 class="testimonial-customer-name">Shetty Jamie*/}
                {/*                                    </h2>*/}
                {/*                                </div>*/}
                {/*                            </div>*/}
                {/*                        </div>*/}
            ...
            <section className="section section-padding top-border p-t-10 p-b-10 m-b-0">
              ...
              {/*                    data-columns2="3" data-columns1="4" data-columns1440="4"*/}
              {/*                    data-columns="5">*/}
              {/*                    <div class="item slick-slide">*/}
              {/*                        <div class="item-image animation-horizontal">*/}
              {/*                            <a href="#">*/}
              {/*                                <img width="450" height="450" src="media/brand/1.jpg"*/}
              {/*                                    alt="Brand 1">*/}
              {/*                            </a>*/}
              {/*                        </div>*/}
              {/*                    </div>*/}
